...
2.  **Stage 2 - LightGBM**: Đóng vai trò là "chuyên gia tinh chỉnh". Nó học trên các sai số (Residuals) của Prophet, sử dụng các đặc trưng ngắn hạn như Lag (7 ngày qua), Rolling Window (trung bình trượt) để đưa ra con số chính xác nhất.
